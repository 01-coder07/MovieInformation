    ...
    <div>
      <div>
       ...
       <div className='flex flex-col sm:flex-row justify-center gap-4 my-10 px-4 '>
        ...
        <button className='w-full sm:w-auto cursor-pointer font-serif py-5 px-5 bg-amber-50 rounded-3xl hover:bg-amber-400 transition-all duration-300 ease-in-out scale-105' onClick={handleMovie}>Search</button>
       </div>
