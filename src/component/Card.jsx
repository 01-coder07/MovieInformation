...
function Card({Poster  , Title , Type , Year,imdbID }) {
  ...
  return (
    ...
    className='bg-amber-200 rounded-2xl shadow-lg  transform hover:-translate-y-2 hover:scale-105 
                transition duration-300 shadow-md hover:shadow-2xl cursor-pointer active:scale-95'>
